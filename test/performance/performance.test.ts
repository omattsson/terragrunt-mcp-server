...
describe('Performance Benchmarks', () => {
  ...
  describe('1. Large Result Set Handling', () => {
    ...
    it('should list all resources without timeout', async () => {
      ...
      expect(duration).toBeLessThan(6500); // Should complete in <6.5 seconds (increased due to comprehensive function metadata extraction and CI environment overhead)
