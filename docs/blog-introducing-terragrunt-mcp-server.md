...
The `diagnose_terragrunt_error` tool includes 110 error patterns across 12 categories with confidence scoring and fuzzy matching.
...
| **Error pattern matching** | Generic troubleshooting | 110 specialized patterns with confidence scores |
